...
\author{
    \IEEEauthorblockN{Artem Tsvetkov} \vspace*{3.0pt}
    \IEEEauthorblockA{
        \textit{Computer Science \& Engineering Dept.} \\
        \textit{SSTU named after Yuri Gagarin, Russia} \\
        artem.tsvetkov@student.sstu.ru
    }
    \and
    \IEEEauthorblockN{Artem Tsvetkov} \vspace*{3.0pt}
    \IEEEauthorblockA{
...
\end{table}
    ...
    % Adjusted figure commands with exact file names
    \begin{figure}[H]
        \centering
...
\section{Preprocessing}
    \subsection{Dataset Parameters}
        ...
        \subsection*{Best Features}
            ...
            So we had used \href{https://scikit-learn.org/stable/modules/generated/sklearn.feature_selection.SelectKBest.html}{SelectKBest} and then categorized and predicted all the 8668 features which can be viewed in \href{../../../../archive/legacy_helpers/helper_files/Best Festures/feature_scores.txt}{\textbf{Features Scores}}.

            Since there were a lot of features for us to analyse, we then printed only those features with scores greater than 100 which can be viewed in \href{../../../../archive/legacy_helpers/helper_files/Best Festures/significant_features.txt}{\textbf{Best Features Scores}}.
...
\section{Command Line Interface}
    ...
    The CLI can be accessed in \href{../../../../archive/legacy_apps/main.py}{\textbf{main.py}}
...
\section{Conclusion}
    ...
    The application can be accessed in \href{../../../../archive/legacy_apps/main.py}{\textbf{main.py}}

    The model can be viewed in \href{../../../../archive/legacy_models/models/gradient_boost.py}{\textbf{Models/gradient\_boost.py}}.

    The other models can be viewed \href{../../../../archive/legacy_models/models}{\textbf{here}}.

    The accuracies of all the models can be viewed \href{../../../../archive/legacy_models/models/accuracies.text}{\textbf{here}}.

\section*{Acknowledgment}
    The authors would like to extend their sincerest gratitude to \href{}{Dr A V Subramanyam} \textit{(Computer Science \& Engineering Dept., \href{}{SSTU named after Yuri Gagarin})} for their invaluable guidance throughout the project.
