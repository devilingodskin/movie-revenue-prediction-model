...
\section{Preprocessing}
    ...
    \subsection{Feature Scaling}
        Enhanced feature preprocessing is implemented in \href{../../../../archive/legacy_models/models/feature_scaling.py}{\textit{feature scaling.py}}:
        \begin{itemize}
...
\section{User Interfaces for Movie Revenue Prediction}
    ...
    \subsection{Command Line Interface (CLI)}
        The CLI can be accessed via \href{../../../../archive/legacy_apps/main.py}{\textbf{main.py}}. Producers can run \textit{python main.py} and enter the required parameters to predict the revenue for their upcoming movie, as envisioned in our Problem Statement.
